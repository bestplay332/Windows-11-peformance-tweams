# Windows-11-peformance-tweams
Windows 11 Nuclear Purge (2026 Edition) A high-performance PowerShell framework designed to strip Windows 11 of background telemetry, AI-driven data collection, and system-wide latency. 100% native commands. No third-party executables. Zero bloat and make a restore point if you did it go to powershell as administrator and copy and paste this # ============================================================
...
# --- 1. THE "SLOP" & CACHE PURGE (System & Apps) ---
...
# --- 3. KERNEL & HARDWARE PRIORITY (Zero Latency) ---
Disable-MMAgent -mc
...
# --- 5. THE "PIXEL" BLACKOUT (Aesthetics & Minimal Bar) ---
...
# --- 7. FINAL SYSTEM POLISH (Repair & Explorer Restart) ---
